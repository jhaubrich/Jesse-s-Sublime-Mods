...
Additions
---------
Sourcecode block formatting -- seems to break the verbatum stuff though.
(think i fixed that.)

.. sourcecode:: python
  import pdb
  import math
  some_crazy_variable = 'yup'
...
.. sourcecode:: consle
  $ ssh jhaubrich@modok
  BusyBox v1.2.3 (2010.04.01-17:20+0000) Built-in shell (ash)
...
**enumerated** lists (numbers, letters or roman numerals; quickref__)
  ...
  a. lower-case letters
     ...
     3. with a sub-list starting at a different number
     4. make sure the numbe * rs are in the correct sequence though!
